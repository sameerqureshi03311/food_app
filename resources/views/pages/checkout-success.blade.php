...
<section class="py-5" style="padding-top: 150px !important; min-height: 80vh;">
    <div class="container-xl text-center" style="max-width: 750px;">
        
        <!-- Animated Success Diamond -->
        <div class="d-inline-flex align-items-center justify-content-center mb-4 rounded-circle" style="width: 80px; height: 80px; background: rgba(212,175,55,0.15); border: 2px solid var(--gold);">
        ...
        <div class="luxury-card p-4 p-md-5 mx-auto mb-4 text-start" style="background-color: var(--obsidian-card);">
